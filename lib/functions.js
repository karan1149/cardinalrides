...
getTime = function(flight){
  ...
  var time = (flight.timeModifier === "pm" && parseInt(flight.time.substring(0,flight.time.indexOf(':'))) != 12 ? (parseInt(flight.time.substring(0,flight.time.indexOf(':'))) + 12) + flight.time.substring(flight.time.length - 3) : flight.time); // 12:00 pm does not need to be adjusted
